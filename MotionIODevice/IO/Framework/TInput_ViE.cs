...
namespace MotionIODevice.IO
{
    public class TInput_ViE
    {
        ...
        public TInput_ViE(int Module, ushort BoardID, int AxisPort, ushort ModuleID, int Bit, string Label, string Name, ushort Mask = 0, string DisplayName = null)
        {
            this.Module = Module;
